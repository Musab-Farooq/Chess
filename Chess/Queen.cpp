...
void Queen::setsprite(string img, int posX, int posY)
{
...
void Queen::setposition(sf::RectangleShape** grid, int n, int m, int** gridposition)
{
    this->verticle = n;
    this->horizontal = m;
...
void Queen::gridvalue(int value, int enemy, int king, int kingenemy)
{
    this->gridval = value;
...
void Queen::movement(sf::Event event, sf::RectangleShape** grid, sf::Mouse mouse, int** gridposition)
{
        ...
        if ((grid[verticle][horizontal].getPosition().x <= mouse.getPosition().x && grid[verticle][horizontal].getPosition().x + 80 >= mouse.getPosition().x) && (grid[verticle][horizontal].getPosition().y <= mouse.getPosition().y && grid[verticle][horizontal].getPosition().y + 80 >= mouse.getPosition().y)) {
            if (event.type == sf::Event::MouseButtonPressed) {
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    if (verticle + i <= 7) {
                        if ((grid[verticle + i][horizontal].getPosition().x <= mouse.getPosition().x && grid[verticle + i][horizontal].getPosition().x + 80 >= mouse.getPosition().x) && (grid[verticle + i][horizontal].getPosition().y <= mouse.getPosition().y && grid[verticle + i][horizontal].getPosition().y + 80 >= mouse.getPosition().y)) {

                            bool check = true;
                            for (int j = i; j > 0; j--) {
                                if (gridposition[verticle + j][horizontal] == gridval || gridposition[verticle + j][horizontal] == king) {
                                    check = false;
                                    break;
                                }

                                if (j < i&& gridposition[verticle + i - j][horizontal] == enemyposition) {
                                    check = false;
                                    break;
                                }
                            }
                            ...
                            if (check) {
                                for (int j = i; j > 0; j--) {
                                    if (gridposition[verticle + i - j][horizontal] == kingenemy) {
                                        this->kingcheck = true;
                                        break;
                                    }
                                }
                    ...
                    if (horizontal + i <= 7) {
                        if ((grid[verticle][horizontal + i].getPosition().x <= mouse.getPosition().x && grid[verticle][horizontal + i].getPosition().x + 80 >= mouse.getPosition().x) && (grid[verticle][horizontal + i].getPosition().y <= mouse.getPosition().y && grid[verticle][horizontal + i].getPosition().y + 80 >= mouse.getPosition().y)) {

                            bool check = true;
                            for (int j = i; j > 0; j--) {
                                if (gridposition[verticle][horizontal + j] == gridval || gridposition[verticle][horizontal + j] == king) {
                                    check = false;
                                    break;
                                }

                                if (j < i&& gridposition[verticle][horizontal + i - j] == enemyposition) {
                                    check = false;
                                    break;
                                }
                            }
                            ...
                            if (check) {
                                for (int j = i; j > 0; j--) {
                                    if (gridposition[verticle][horizontal + i - j] == kingenemy) {
                                        this->kingcheck = true;
                                        break;
                                    }
                                }
